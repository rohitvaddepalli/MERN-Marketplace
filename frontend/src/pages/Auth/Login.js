...
const Login = () => {
    ...
    React.useEffect(() => {
        // Only navigate if authenticated, user data AND role are loaded, auth is not loading, and we haven't navigated yet
                    ...
                    <div className="auth-form-wrapper">
                        ...
                        <div className="social-login-buttons" style={{ display: 'flex', gap: '1rem', marginBottom: '1.5rem' }}>
                            <button
                                ...
                                style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem', cursor: 'pointer', background: 'white', border: '1px solid #e1e1e1' }}
                            >
