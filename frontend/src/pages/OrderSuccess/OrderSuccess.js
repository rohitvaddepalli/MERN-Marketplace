            ...
            <div className="container">
                <div className="success-card">
                    ...
                    <p className="email-confirmation">
                        We've sent a confirmation email to <strong>{order.guestInfo?.email || user?.email}</strong>
                    </p>

                    {!user && order.guestInfo && (
                        <div className="guest-account-creation">
                            <h3>Create an account to track your order</h3>
                            <p>Enter a password to create your account instantly using the details from your order.</p>
