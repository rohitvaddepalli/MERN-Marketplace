                ...
                <div className="container">
                    <div className="terms-container">
                        <div className="terms-section">
                            ...
                            <p>
                                By accessing and using Marketplace, you accept and agree to be bound by the terms and
                        ...
                        <div className="terms-section">
                            <h2>2. Use License</h2>
                            <p>
                                Permission is granted to temporarily download one copy of the materials on Marketplace's
                            ...
                            <ul>
                                ...
                                <li>Attempt to reverse engineer any software contained on Marketplace's website</li>
                        ...
                        <div className="terms-section">
                            ...
                            <ul>
                                <li>Systematically retrieve data or other content from the Site to create a collection</li>
                        ...
                        <div className="terms-section">
                            ...
                            <p>
                                All prices are listed in the currency specified on the product page. Sellers are responsible
                                for setting their own prices. Marketplace charges a commission on each sale as outlined in
                                our Seller Agreement.
                            </p>
                            <p>
                                Payment processing is handled by third-party payment processors. By making a purchase, you
                        ...
                        <div className="terms-section">
                            ...
                            <p>
                                Our return policy allows customers to return most items within 30 days of delivery. Items
                                must be unused and in original packaging. Refunds are processed within 5-7 business days
                                after we receive the returned item.
                            </p>
                            <p>
                                Some items may not be eligible for returns. Please check the product page for specific
                                return policies.
                            </p>
                        </div>
                        ...
                        <div className="terms-section">
                            ...
                            <p>
                                The Site and its entire contents, features, and functionality are owned by Marketplace and
                        ...
                        <div className="terms-section">
                            ...
                            <p>
                                In no event shall Marketplace, nor its directors, employees, partners, agents, suppliers,
