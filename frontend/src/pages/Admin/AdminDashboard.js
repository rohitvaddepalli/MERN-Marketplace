...
const AdminDashboard = () => {
    ...
    const statCards = [
        ...
        },
        {
            ...
            icon: (
                <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
                    <path d="M20 7H4m16 0v10a2 2 0 01-2 2H6a2 2 0 01-2-2V7m16 0l-1-4H5L4 7" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
            ),
        ...
        },
        {
            ...
            icon: (
                <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
                    <path d="M16 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2M8.5 11a4 4 0 100-8 4 4 0 000 8zM20 8v6M23 11h-6" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
            ),
                            ...
                            <div className="admin-list">
                                {stats?.recentUsers?.slice(0, 5).map((user) => (
                                    <div key={user._id} className="admin-list-item">
                                        ...
                                        <span className={`badge badge-${user.role === 'seller' ? 'warning' : 'info'}`}>
                                            {user.role}
                                        </span>
                                    </div>
                                ))}
